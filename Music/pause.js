...
module.exports = {
  ...
  execute(message) {
    ...
    if (queue.playing) {
      ...
      .setAuthor(`${message.author.username} paused the music.`, "https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205")
