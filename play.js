...
module.exports = {
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#F0EAD6")
        .setAuthor(`Music Queue ended.`, "https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205")
  ...
  let thumb;
    if (song.thumbnail === undefined) thumb = "https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205";
    else thumb = song.thumbnail.url;

  try {
      let embed = new MessageEmbed()
      .setColor("#F0EAD6")
      .setAuthor(`Started playing: ${song.title}`,'https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205')
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        let nowPlaying = new MessageEmbed()
          .setAuthor('♪Now playing♪','https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205','http://harmonymusic.tk')
      ...
      if (ms > 0 && ms<10000) {
        nowPlaying.addField("\u200b", "**``[" + createBar((ms == 0 ? seek : ms), seek, 25, "▬", "🔘")[0] + "]``**\n**" + "\n[" + new Date(seek * 1000).toISOString().substr(11, 8) + " / " + (ms == 0 ? " ◉ LIVE" : new Date(ms * 1000).toISOString().substr(11, 8))+ "]**" + "\n" + "\n **Time Remaining:**" + "``" + new Date(left * 1000).toISOString().substr(11, 8) + "``", false );
          ...
          .setAuthor("Searching...", "https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205").setFooter("Lyrics")
          .setColor("#F0EAD6")
