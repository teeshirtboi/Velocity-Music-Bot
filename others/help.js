...
module.exports = {
  ...
  execute(message,args,client) {
    ...
    let helpEmbed = new MessageEmbed()
      .setTitle("Velocity Help")
      .setAuthor('Click here to invite me!!', 'https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205', 'https://discord.com/oauth2/authorize?client_id=775671437842317343&permissions=49572160&scope=bot')
      .setDescription(`**PREFIX:** \`${PREFIX}\``)
      .setFooter( client.user.username +`Type: ${PREFIX}help <Command>  for more information!`, "https://media.discordapp.net/attachments/775702901393063937/873089889770561587/f9f93b7ed4219865fd504af72d97644b.png?width=205&height=205")
      .setColor("#F0EAD6");
